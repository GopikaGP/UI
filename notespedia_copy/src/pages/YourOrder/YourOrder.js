...
const YourOrder = () => {
  ...
  <div className="main_o"> <span id="sub-title">
    ...
    <div className="row row-main">
      <div className="col-3"> <img className="img-fluid" src="https://i.imgur.com/WuJwAJD.jpg"/> </div>
      <div className="col-6">
        <div className="row d-flex">
          <p><b>Airpods</b></p>
        </div>
    ...
    <div className="total">
      ...
      </div> <button className="btn d-flex mx-auto"> Track your order </button>
    </div>
  </div>
</div>
